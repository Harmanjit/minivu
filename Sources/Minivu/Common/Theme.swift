...
enum ThemeColors {
    ...
    static let contentBackground = NSColor(name: "minivu.content") { appearance in
    ...
    static let selectionFill = NSColor(name: "minivu.selection") { _ in
        NSColor.controlAccentColor.withAlphaComponent(0.35)
    }

    /// Unselected thumbnail cell hover fill.
    static let hoverFill = NSColor(name: "minivu.hover") { appearance in
