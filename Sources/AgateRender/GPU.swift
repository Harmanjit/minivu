...
public enum GPUError: Error, CustomStringConvertible {
    ...
    public var description: String {
        ...
        case .shadersNotFound: "No Metal shader sources or library found in the AgateRender bundle."
...
extension Bundle {
    /// AgateRender's resource bundle, found where a shipped app keeps it.
    ///
    ...
    public static let agateRender: Bundle = {
        let name = "agate_AgateRender.bundle"
