...
@Suite struct SnapshotConfigurationTests {
    ...
    @Test func offWithoutOutputPath() {
        ...
        #expect(Configuration(environment: ["MINIVU_SNAPSHOT": ""]) == nil)
        #expect(Configuration(environment: ["MINIVU_OPEN": "/tmp"]) == nil)
    }

    @Test func defaults() throws {
        let config = try #require(Configuration(environment: ["MINIVU_SNAPSHOT": "/tmp/a.png"]))
    ...
    @Test func readsEveryVariable() throws {
        let config = try #require(Configuration(environment: [
            "MINIVU_SNAPSHOT": "~/shot.png",
            "MINIVU_OPEN": "/Users/someone/Pictures",
            "MINIVU_WINDOW_SIZE": "1400x900",
            "MINIVU_ACTIONS": "openInViewer:; zoomIn: ;;",
            "MINIVU_SNAPSHOT_DELAY": "0.25",
            "MINIVU_SNAPSHOT_WINDOW": "Settings",
        ]))
